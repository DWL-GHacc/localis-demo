...
return (
    ...
    <section className="py-5 bg-light">
        ...
        <Row className="mb-4">
            ...
            <p className="text-muted mb-0">Secure access, clear visuals, exportable insights.</p>
            </Col>
        </Row>
        <Row className="g-3">
            <Col md={4}>
            <Card className="h-100 shadow-sm">
                <Card.Body>
                    ...
                    <Card.Text className="text-muted">Access your destination's private hub with role-based permissions.</Card.Text>
                </Card.Body>
                </Card>
                </Col>
            ...
            <Card className="h-100 shadow-sm">
                <Card.Body>
                    ...
                    <Card.Text className="text-muted">Visualise trends across flights, accommodation, spending and mobility.</Card.Text>
                </Card.Body>
            </Card>
            </Col>
            ...
            <Card className="h-100 shadow-sm">
                <Card.Body>
                    ...
                    <Card.Text className="text-muted">Export charts, share reports and inform strategy with confidence.</Card.Text>
                </Card.Body>
                </Card>
                </Col>
        </Row>
        ...
        <Container>
            <Row className="align-items-center gy-4">
                ...
                <p className="text-muted">
                    See visitor volumes, spending patterns and accomodation trends at a glance.
                    Hover, filter, compare and export in seconds.
                </p>
