...
const getLengthAllData = async () => {
  const url = "http://localhost:3000/api/spend_data";
...
const getSpendDisttinctLGAs = async () => {
  const url = "http://localhost:3000/api/spend_data/distinct_lgas_spend";
...
const getSpendDataRange = async () => {
  const url = "http://localhost:3000/api/spend_data/data_range";
...
const getSpendCategories = async () => {
  const url = "http://localhost:3000/api/spend_data/categories";
...
const getSpendRegions = async () => {
  const url = "http://localhost:3000/api/spend_data/regions";
...
const getSpendSumByCategories = async (category) => {
  const url = "http://localhost:3000/api/spend_data/spend_by_category";

  return fetch(url).then((response) => response.json());
};

const getSpendIntensityAllRegions = async () => {
  const url = "http://localhost:3000/api/spend_data/spend_intensity";
...
const getSpendSumByRegions = async () => {
  const url = "http://localhost:3000/api/spend_data/spend_by_region";
...
const getSpendSumByCategoriesPerRegion = async (region) => {
  const url = `http://localhost:3000/api/spend_data/category_spend_per_region?region=${region}`;
...
const getSpendMonthlySumPerRegion = async () => {
    const url = "http://localhost:3000/api/spend_data/monthly_spend_per_region";
